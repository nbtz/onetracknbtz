...
<div class="user-form">
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title"><?=Yii::t('user', 'Update Profile')?></h4>
        </div>
        <div class="panel-body">
                <?php $form = ActiveForm::begin(['id' => 'profile-form', 'action' => ['profile'], 'method' => 'post', 'options' => ['enctype' => 'multipart/form-data']]);?>
...
?>
	...
	'prompt' => Yii::t('main', '... Select ...'),
                    ...
                    <div class="col-sm-6"> <?php
if (isset(Yii::$app->user->identity->company->id) && !empty(Yii::$app->user->identity->company->id)) {
	$positionList = ArrayHelper::map(Position::find()->where(['company_id' => Yii::$app->user->identity->company->id, 'status' => 1])->all(), 'id', 'postion_name');
} else {
	$positionList = [];
}
?>
...
?>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title"><?=Yii::t('user', 'Change Password')?></h4>
        </div>
        <div class="panel-body">
        	 <?php $form = ActiveForm::begin(['id' => 'profile-form', 'action' => ['profile'], 'method' => 'post', 'options' => ['enctype' => 'multipart/form-data']]);?>
                ...
                <div class="row">
                    <div class="col-sm-5"><?=$form->field($modelPassword, 'password_old')->passwordInput()?></div>
                </div>
                <div class="row">
                    <div class="col-sm-5"><?=$form->field($modelPassword, 'password')->passwordInput()?></div>
                </div>
                <div class="row">
                    <div class="col-sm-5"><?=$form->field($modelPassword, 'password_repeat')->passwordInput()?></div>
                </div>
