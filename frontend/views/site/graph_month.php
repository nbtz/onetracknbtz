...
echo $firstdate . " - " . $today . "<br><br>";

$modelCheckin = CheckIn::find()->where(['company_id' => Yii::$app->user->identity->company->id])->andWhere(['between', 'DATE(chk_time)', $firstdate, $today])->all();
