...
class Gpsdata extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mobileunitid', 'latitude', 'longitude', 'speed', 'course', 'input', 'output', 'temp', 'tambon', 'province', 'amphur', 'trip', 'analog2', 'stationid', 'port', 'phone_number', 'server_ip', 'poi', 'rpm', 'refno', 'schild', 'seqno', 'service_id', 'in_station', 'out_sttion', 'ram_avl', 'sat'], 'integer'],
            ...
            [['kmx', 'batt', 'ram_total', 'disk_ext_avl', 'disk_ext_total', 'disk_avl', 'disk_total', 'accuracy', 'alt', 'bearing'], 'number'],
            [['uuid'], 'string', 'max' => 100],
